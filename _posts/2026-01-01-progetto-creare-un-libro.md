...
Avete mai pensato di trasformare i racconti della buonanotte o i disegni sparsi sul tavolo in un vero libro? Recentemente avviato che si è concluso con una prima pubblicazione reale e altre ancora in corso di realizzazione.

Abbiamo affrontare un vero e proprio progetto, suddiviso in 6 fasi chiave, dove ogni membro della famiglia ha avuto un ruolo fondamentale.
...
4. **Impaginazione e composizione:** Qui è entrata in gioco la **tecnologia**. Abbiamo usato il software per impaginazione, scrittura ed elaborazione di immagini per realizzare il maser digitale del libro. I disegni sono stati interamente realizzati a mano. Niente AI generativa per questo progetto! Carta, pastelli e scanner. 
5. **Revisione delle bozze:** Un esercizio di attenzione e lettura critica per scovare refusi, errori grafici e valutare possibili alternative.
6. **Distribuzione e pubblicazione:** Scegliere il canale e la modalità di pubblicazione e distribuzione è stato più impegnativo del previsto. Le opzioni disponibili sono tante e abbiamo imparato tante cose.
...
Realizzare un libro richiede un mix di competenze **analogiche e digitali**: scrittura, lettura, disegno a mano libera e grafica digitale. Ma la lezione più grande è stata imparare il **lavoro di squadra** su un progetto a lungo termine con ruoli e responsabilità ben definiti. Si tratta di esperienza comune per gli adulti in molti contesti lavorativi, ma per dei bambini che frequentano al scuola di infanzia e la primaria è una cosa nuova.

Ogni opera è un progetto a se stante che richeide scelte strategiche che poi orientano tutto il flusso di lavoro. Ad esempio, per il nostro libro **"I Gatti e le Stagioni"**, abbiamo stabilito di escudere tutti gli aspetti *business* dal progetto: l'investimento economico è stato ridotto al minimo (euro per le bozze fatte stampare in tipografia) e il libro viene distribuito al prezzo minimo che possibile senza nessun guadagno per noi.

Questa scelta ha influenzato tutto il processo, dalla scelta del formato digitale alla selezione dei canali di distribuzione gratuiti, insegnando ai bambini che ogni progetto nasce da un obiettivo chiaro.
